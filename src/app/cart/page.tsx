...
const CartPage = () => {
    ...
    const handleRemove = (id: string) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setCartItems(getCartItems()); // Update local state
    ...
    const handleQuantityChange = (id: string, quantity: number) => {
        updateCartQuantity(id, quantity); // Update quantity in cart
        setCartItems(getCartItems()); // Update local state
    };
    ...
    const handleIncrement = (id: string) => {
        ...
        if (product) {
            handleQuantityChange(id, product.inventory + 1); // Increase quantity by 1
        }
    };
    ...
    const handleDecrement = (id: string) => {
        ...
        if (product && product.inventory > 1) {
            handleQuantityChange(id, product.inventory - 1); // Decrease quantity by 1
        }
    };
